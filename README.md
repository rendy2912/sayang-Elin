...
1. Taruh 2 file musik di `assets/`:
   - `assets/music.mp3` — main pas rangkaian 100 scene, lalu melembut menjelang scene terakhir.
   - `assets/music2.mp3` — main pas pesan utama muncul, volumenya naik perlahan.
